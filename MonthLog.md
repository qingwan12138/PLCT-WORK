...
- 通过ruyisdk虚拟环境从源代码编译和运行 TeeWorlds
### [Cavestoryen](https://ruyisdk.cn/t/topic/2563)
- 通过ruyisdk虚拟环境从源代码编译和运行 nxengine-evo引擎并运行cavestoryen

### [Sonic Robo Blast 2](https://ruyisdk.cn/t/topic/2579)
- 通过ruyisdk虚拟环境从源代码编译和运行 Sonic Robo Blast 2